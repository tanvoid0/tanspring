...
class JwtUtilTest {
    ...
    /**
     * Method under test: {@link JwtUtil#getUsernameFromHttpRequest(HttpServletRequest)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUsernameFromHttpRequest() {
        ...
        // Act
        String actualUsernameFromHttpRequest = JwtUtil.getUsernameFromHttpRequest(request);
    ...
    void testValidateToken() {
        assertThrows(BlogAPIException.class, () -> JwtUtil.validateToken("ABC123"));
    }

    /**
     * Method under test: {@link JwtUtil#getUsernameFromJWT(String)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetUsernameFromJWT() {
        ...
        JwtUtil.getUsernameFromJWT("ABC123");
    }
}
